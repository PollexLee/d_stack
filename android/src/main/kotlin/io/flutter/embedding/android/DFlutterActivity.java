...
public class DFlutterActivity extends Activity
        implements DFlutterPageDelegate.Host, LifecycleOwner {
    ...
    @VisibleForTesting
    /* package */ void setDelegate(@NonNull DFlutterPageDelegate delegate) {
